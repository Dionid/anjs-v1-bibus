import {debugAndIsAuthNAspect} from "aspects";
import {ChangeEmailByUserCommand, changeEmailByUserCommandHandler} from "commands/handlers/change-email-by-user";
import {UserEmail} from "commands/models/user-email";
import {getUserQueryHandler} from "queries/handlers/get-user";


export const getUserQueryHandlerWithAspects = debugAndIsAuthNAspect(getUserQueryHandler)
